...
class PointCloudMerger(Node):
    def __init__(self):
        ...
        # 여러 LiDAR로부터 토픽을 구독
        # self.lidar1_sub = Subscriber(self, PointCloud2, '/lidar_11_201/TFpoints_new')
        # self.lidar2_sub = Subscriber(self, PointCloud2, '/lidar_12_201/TFpoints_new')
        # self.lidar3_sub = Subscriber(self, PointCloud2, '/lidar_13_201/TFpoints_new')
        self.lidar1_sub = Subscriber(self, PointCloud2, '/TFnonground/lidar_11')
        self.lidar1_sub = Subscriber(self, PointCloud2, '/TFnonground/lidar_12')
        self.lidar1_sub = Subscriber(self, PointCloud2, '/TFnonground/lidar_13')
        ...
        self.pub = self.create_publisher(PointCloud2, '/merge_201/points', 10)
