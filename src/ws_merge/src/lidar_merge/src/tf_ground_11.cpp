...
public:
    ...
    : Node("lidar_transformer_11_cpp")
    {
        ...
        // tf2::Quaternion q(0.0, 0.0, 0.552199, 0.833712);  // fusion22
        tf2::Quaternion q(0.0, 0.0, 0.543835, 0.839192);  // 260623 해주
        ...
        RCLCPP_INFO(this->get_logger(), "Translate LiDAR_11 points initialized");
    }
