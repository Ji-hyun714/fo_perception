...
public:
  ...
  : Node("lidar_merge_node")
  {
    ...
    sub_lidar1_ = this->create_subscription<PointCloud2>(
      "/nonground/lidar_11", 10, std::bind(&PointCloudMerger::callbackLidar1, this, _1));
    sub_lidar2_ = this->create_subscription<PointCloud2>(
      "/nonground/lidar_12", 10, std::bind(&PointCloudMerger::callbackLidar2, this, _1));
    sub_lidar3_ = this->create_subscription<PointCloud2>(
      "/nonground/lidar_13", 10, std::bind(&PointCloudMerger::callbackLidar3, this, _1));
